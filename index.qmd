...
img_path = 'memeChallenge.jpeg'  # Example image - replace with your own image
...
#| eval: true   # <-- change this (or just remove the line to use the default)
...
This meme shows selection bias by starting with the full party photo as reality, then hiding dots in an S-shaped pattern. Because those missing dots are not random, the final picture (Estimate) no longer matches the real crowd, just like a biased sample doesn’t match the true population.
